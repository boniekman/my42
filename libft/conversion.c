...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/02/25 20:02:42 by mbonowic          #+#    #+#             */
/*   Updated: 2016/05/18 11:22:29 by mbonowic         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		get_size(char *inst)
{
	...
	while (inst[i] && ft_isdigit(inst[i]))
		i++;
	i += is_preci(inst + i);
	i += is_modifier(inst + i);
	while (inst[i] && is_modifier(inst + i))
		i++;
